...
class SalesDatasourceConfig {
    ...
    fun salesLiquibase(
        ...
        @Value("\${datasource.sales.port}") port: String): SpringLiquibase? {
        return springLiquibase(salesDataSource(dbName, username, pwd, server, port), salesLiquibaseProperties())
    }
    ...
    fun salesDataSource(
        ...
        @Value("\${datasource.sales.password}") pwd: String,
        @Value("\${datasource.sales.server}") server: String,
        @Value("\${datasource.sales.port}") port: String): AtomikosDataSourceBean {
    ...
    @Bean
    fun salesEntityManager(@Value("\${datasource.sales.database}") dbName: String,
                           @Value("\${datasource.sales.username}") username: String,
                           @Value("\${datasource.sales.password}") pwd: String,
                           @Value("\${datasource.sales.server}") server: String,
                           @Value("\${datasource.sales.port}") port: String): EntityManagerFactory {
